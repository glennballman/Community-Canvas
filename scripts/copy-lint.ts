...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; name: string }> = [
  ...
  { pattern: /\bbid\b/gi, name: 'bid' },
  { pattern: /\bbids\b/gi, name: 'bids' },
  { pattern: /\bbidding\b/gi, name: 'bidding' },
  { pattern: /\bquote\b/gi, name: 'quote' },
  { pattern: /\bquotes\b/gi, name: 'quotes' },
  { pattern: /\bestimate\b/gi, name: 'estimate' },
  { pattern: /\bestimates\b/gi, name: 'estimates' },
];
...
const CONTEXT_ALLOWLIST: Array<{ file: RegExp; patterns: RegExp[] }> = [
  ...
  {
    file: /transportIntegrationService/,
    patterns: [/quote/i],
  },
  {
    file: /cartService/,
  ...
  {
    file: /ConversationView/,
    patterns: [/bid/i],
  },
  {
    file: /ConversationList/,
    patterns: [/bid/i],
  },
  {
    file: /OnboardingResultsPage/,
    patterns: [/quote/i],
  },
  {
    file: /PortalZonesPage/,
    patterns: [/estimate/i],
  },
  {
    file: /InventoryOnboarding/,
    patterns: [/estimate/i, /quote/i],
  },
  {
    file: /ServiceRunAttention/,
    patterns: [/estimate/i],
  },
  {
    file: /ServiceRunMonitor/,
    patterns: [/estimate/i],
  },
  {
    file: /CreateProject/,
  ...
  {
    file: /CreateServiceRun/,
    patterns: [/bid/i],
  },
  {
    file: /ServiceRunDetail/,
    patterns: [/bid/i],
  },
  {
    file: /shared-runs/,
    patterns: [/estimate/i, /bid/i],
  },
  {
    file: /public-portal/,
    patterns: [/quote/i],
  ...
  {
    file: /services\//,
    patterns: [/bid/i, /estimate/i, /quote/i],
  },
  {
    file: /publicCrossSellOrdering/,
    patterns: [/bId/],
  },
  {
    file: /mobilizationSplit/,
    patterns: [/estimate/i],
  },
  {
    file: /routes\/individuals/,
    patterns: [/bid/i],
  },
  {
    file: /routes\/media/,
