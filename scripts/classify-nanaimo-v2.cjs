...
const junkPatterns = [
  ...
  /^greater nanaimo/i,
  /^chambermaster/i,
  /^V\d[A-Z]\s?\d[A-Z]\d$/i,  // Postal codes
  /^nanaimo\s*bc\s*v\d/i,  // City + postal code fragments
  /^bc\s*v\d/i,
];
...
// Valid BusinessCategory values and classification keywords
const categoryMapping = {
  ...
  'banking-finance': ['bank', 'credit union', 'mortgage', 'financial', 'investment', 'wealth', 'advisor', 'securities', 'brokerage', 'financing', 'capital'],
  ...
  'construction': ['construction', 'contractor', 'builder', 'excavation', 'paving', 'concrete', 'framing', 'drywall', 'demolition'],
  ...
  'environmental': ['environmental', 'recycling', 'waste management', 'green', 'eco'],
  'first-nations': ['first nation', 'indigenous', 'band office', 'treaty'],
  'fishing-marine': ['fishing', 'marine', 'boat', 'yacht', 'charter fishing', 'seafood'],
  'fitness-wellness': ['fitness', 'gym', 'yoga', 'pilates', 'wellness', 'health club', 'crossfit'],
  ...
  'government': ['city of', 'regional district', 'government', 'ministry', 'federal', 'provincial', 'municipal'],
  ...
  'heating-cooling': ['hvac', 'heating', 'cooling', 'air conditioning', 'furnace'],
  ...
  'it-technology': ['technology', 'software', 'it', 'computer', 'tech', 'digital', 'cyber', 'data', 'cloud', 'network', 'telecom', 'internet', 'app', 'developer', 'programming', 'web design', 'web development'],
  ...
  'manufacturing': ['manufacturing', 'factory', 'industrial', 'fabrication', 'production', 'processing', 'assembly', 'welding', 'metal', 'steel', 'plastics', 'woodworking', 'millwork', 'cabinet'],
  ...
  'printing': ['printing', 'print shop', 'signage', 'sign shop', 'banner'],
  'property-management': ['property management', 'strata', 'building management'],
  'real-estate': ['real estate', 'realtor', 'realty', 'property', 'homes', 'housing'],
  ...
  'spa-beauty': ['spa', 'salon', 'beauty', 'hair', 'nail', 'esthetic', 'massage', 'wellness'],
  'storage': ['storage', 'warehouse', 'self-storage'],
  'taxi-rideshare': ['taxi', 'cab', 'rideshare', 'limo', 'limousine', 'shuttle'],
  'telecommunications': ['phone', 'wireless', 'cable', 'internet provider', 'telecom'],
...
fs.writeFileSync('scripts/nanaimo-integration.json', JSON.stringify(classified, null, 2));
console.log('\nSaved to scripts/nanaimo-integration.json');
