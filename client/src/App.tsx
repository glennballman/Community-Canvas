...
import RunStakeholderViewPage from './pages/app/runs/RunStakeholderViewPage';
...
import NegotiationAuditPage from './pages/app/settings/NegotiationAuditPage';
import ProofVerificationPage from './pages/app/settings/ProofVerificationPage';
          ...
          <TenantProvider>
            ...
            <Routes>
              ...
              <Route path="/app" element={<AppRouterSwitch />}>
                ...
                {/* Stakeholder Run View (STEP 11C Phase 2B-2.1) */}
                <Route path="runs/:id/view" element={<RunStakeholderViewPage />} />
