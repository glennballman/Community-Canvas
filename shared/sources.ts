...
export function mapCategory(firecrawlCategory: string): string {
  ...
  if (cat.includes('news') || cat.includes('cc_media')) return 'news';
  ...
  if (cat.includes('event') || cat.includes('concert') || cat.includes('game') || cat.includes('festival')) return 'cc_events';
...
export const PROVINCIAL_SOURCES: DataSource[] = [
  ...
  // Emergency & Safety
  { category: "emergency", source_name: "Environment Canada Weather Alerts", url: "https://weather.gc.ca/warnings/index_e.html", description: "Official weather warnings, watches, and cc_alerts for all BC regions", is_shared: true },
  { category: "emergency", source_name: "Emergency Info BC", url: "https://www.emergencyinfobc.gov.bc.ca/", description: "Provincial emergency cc_alerts, evacuations, and disaster response", is_shared: true },
  ...
  { category: "emergency", source_name: "Tsunami Warning - NOAA", url: "https://tsunami.gov/", description: "Pacific Tsunami Warning Center cc_alerts", is_shared: true },
  ...
  // Health
  { category: "health", source_name: "BC CDC Health Alerts", url: "https://www.bccdc.ca/about/news-stories/news-releases", description: "Provincial health cc_alerts and disease outbreak information", is_shared: true },
...
export const REGIONAL_SOURCES: Record<string, DataSource[]> = {
  "metro-vancouver": [
    // Transit
    { category: "transit", source_name: "TransLink Alerts", url: "https://www.translink.ca/cc_alerts", description: "Real-time cc_alerts for SkyTrain, bus, SeaBus, and West Coast Express", is_shared: true },
    ...
    // Health
    { category: "health", source_name: "Vancouver Coastal Health", url: "https://www.vch.ca/en/health-cc_alerts", description: "Health cc_alerts for Vancouver, Richmond, North Shore", is_shared: true },
    { category: "health", source_name: "Fraser Health Authority", url: "https://www.fraserhealth.ca/health-topics-a-to-z/public-health-cc_alerts", description: "Public health cc_alerts for Fraser Health region", is_shared: true },
    ...
    // Events
    { category: "cc_events", source_name: "Vancouver Canucks Schedule", url: "https://www.nhl.com/canucks/schedule", description: "NHL Vancouver Canucks game schedule", is_shared: true },
    { category: "cc_events", source_name: "BC Lions Schedule", url: "https://www.bclions.com/schedule", description: "CFL BC Lions game schedule", is_shared: true },
    { category: "cc_events", source_name: "Vancouver Whitecaps Schedule", url: "https://www.whitecapsfc.com/schedule/", description: "MLS Vancouver Whitecaps game schedule", is_shared: true },
    { category: "cc_events", source_name: "Rogers Arena Events", url: "https://rogersarena.com/cc_events/", description: "Concerts and cc_events at Rogers Arena", is_shared: true },
    { category: "cc_events", source_name: "BC Place Events", url: "https://www.bcplace.com/cc_events", description: "Events and concerts at BC Place Stadium", is_shared: true },
    { category: "cc_events", source_name: "Vancouver Events Calendar", url: "https://www.tourismvancouver.com/cc_events/", description: "Major cc_events and festivals in Vancouver", is_shared: true },
    // Financial
  ...
  "capital": [
    ...
    // Health
    { category: "health", source_name: "Island Health", url: "https://www.islandhealth.ca/news", description: "Health cc_alerts for Vancouver Island", is_shared: true },
    // Weather
  ...
  "central-okanagan": [
    ...
    // Health
    { category: "health", source_name: "Interior Health", url: "https://www.interiorhealth.ca/health-topics/news-and-cc_alerts", description: "Health cc_alerts for Interior region", is_shared: true },
    // Aviation
  ...
  "fraser-fort-george": [
    ...
    // Health
    { category: "health", source_name: "Northern Health", url: "https://www.northernhealth.ca/health-topics/news-releases", description: "Health cc_alerts for Northern region", is_shared: true },
    // Aviation
  ...
  "squamish-lillooet": [
    ...
    // Health
    { category: "health", source_name: "Vancouver Coastal Health", url: "https://www.vch.ca/en/health-cc_alerts", description: "Health cc_alerts for Sea-to-Sky corridor", is_shared: true },
  ],
  "sunshine-coast": [
    // Ferry
    ...
    // Health
    { category: "health", source_name: "Vancouver Coastal Health", url: "https://www.vch.ca/en/health-cc_alerts", description: "Health cc_alerts for Sunshine Coast", is_shared: true },
  ],
  "powell-river": [
    // Ferry
    ...
    // Health
    { category: "health", source_name: "Vancouver Coastal Health", url: "https://www.vch.ca/en/health-cc_alerts", description: "Health cc_alerts for Powell River area", is_shared: true },
  ],
  "central-coast": [
    // Regional Government
    ...
    // Health
    { category: "health", source_name: "Vancouver Coastal Health", url: "https://www.vch.ca/en/health-cc_alerts", description: "Health cc_alerts for Central Coast", is_shared: true },
  ],
  "north-coast": [
    // Regional Government
...
export const MUNICIPAL_SOURCES: Record<string, DataSource[]> = {
  "City of Abbotsford": [
    { category: "water", source_name: "Abbotsford Utility Billing", url: "https://www.abbotsford.ca/city-cc_services/utility-billing", description: "Bi-monthly water and sewer utility billing cc_services", is_shared: false },
    { category: "water", source_name: "Water & Wastewater Services", url: "https://www.abbotsford.ca/city-cc_services/water-wastewater", description: "Regional water supply system information for Abbotsford and Mission", is_shared: false },
    ...
    { category: "transit", source_name: "Road Closures & Construction", url: "https://www.abbotsford.ca/city-cc_services/transportation-roads/road-closures", description: "Information on road closures, construction updates, and traffic management", is_shared: false },
    ...
    { category: "emergency", source_name: "City Alerts & Notifications", url: "https://www.abbotsford.ca/cc_alerts", description: "Emergency cc_alerts system for evacuation orders, cc_alerts, and news releases", is_shared: false },
    { category: "news", source_name: "City News & Media", url: "https://www.abbotsford.ca/city-hall/news-cc_media", description: "Official municipal news source with cc_media releases and bulletins", is_shared: false },
    ...
    { category: "economic", source_name: "Building Permits", url: "https://www.abbotsford.ca/city-cc_services/cc_permits-licences/building-cc_permits", description: "Building permit applications, requirements, and issuance processes", is_shared: false },
  ...
  "Village of Anmore": [
    { category: "water", source_name: "Anmore Water Services", url: "https://anmore.com/services/water-cc_services/", description: "Official water service information including water quality reports", is_shared: false },
    ...
    { category: "transit", source_name: "Road Projects", url: "https://anmore.com/village-hall/cc_projects/road-cc_projects/", description: "Ongoing and completed road construction cc_projects", is_shared: false },
    ...
    { category: "news", source_name: "Village Official Website", url: "https://anmore.com/", description: "Official municipal website with latest news and cc_events", is_shared: false },
  ...
  "City of Vancouver": [
    ...
    { category: "emergency", source_name: "Vancouver Alerts", url: "https://vancouver.ca/news-calendar/news.aspx", description: "City of Vancouver news and cc_alerts", is_shared: false },
    ...
    { category: "emergency", source_name: "Vancouver Fire Rescue", url: "https://www.vancouver.ca/fire-rescue-cc_services.aspx", description: "Fire and rescue cc_services information", is_shared: false },
    ...
    { category: "economic", source_name: "Building Permits", url: "https://vancouver.ca/home-property-development/cc_permits-licenses.aspx", description: "Permits and business licenses portal", is_shared: false },
    ...
    { category: "aviation", source_name: "YVR Operational Info", url: "https://www.yvr.ca/en/about-yvr/operational-information", description: "YVR operational information and airport cc_alerts", is_shared: false },
    { category: "aviation", source_name: "YVR Alerts", url: "https://www.yvr.ca/en/passengers/cc_alerts", description: "Current airport cc_alerts and service updates", is_shared: false },
    ...
    { category: "aviation", source_name: "Vancouver Harbour Heliport", url: "https://helijet.com/", description: "Scheduled helicopter airline and charter cc_services", is_shared: false },
  ],
  "District of West Vancouver": [
    ...
    { category: "waste", source_name: "Garbage & Recycling", url: "https://westvancouver.ca/services/garbage-recycling/collection-cc_schedules", description: "Curbside garbage and green can collection cc_schedules", is_shared: false },
    ...
    { category: "transit", source_name: "Parking Services", url: "https://westvancouver.ca/services/transportation/parking", description: "Parking information and cc_permits", is_shared: false },
    ...
    { category: "emergency", source_name: "Emergency Services", url: "https://westvancouver.ca/services/emergency-cc_services", description: "Fire, Police, and emergency preparedness resources", is_shared: false },
    ...
    { category: "economic", source_name: "Development Permits", url: "https://westvancouver.ca/business-development/building-development/building-cc_permits-cc_inspections/development-cc_permits", description: "Development permit applications", is_shared: false },
    { category: "economic", source_name: "Business Licences", url: "https://westvancouver.ca/business-development/information-businesses/cc_permits-licences/business-licences", description: "Business license applications and renewals", is_shared: false },
    ...
    { category: "aviation", source_name: "Helijet Helicopter", url: "https://helijet.com/", description: "Scheduled helicopter and charter cc_services", is_shared: false },
  ],
  "City of Richmond": [
  ...
  "City of Burnaby": [
    { category: "emergency", source_name: "Burnaby Emergency", url: "https://www.burnaby.ca/our-city/emergency-preparedness", description: "Emergency cc_alerts and preparedness", is_shared: false },
    { category: "transit", source_name: "Road Closures", url: "https://www.burnaby.ca/cc_services-and-payments/roads-and-sidewalks", description: "Road closures and construction", is_shared: false },
  ],
  "City of Surrey": [
    { category: "emergency", source_name: "Surrey Emergency", url: "https://www.surrey.ca/about-surrey/emergency-preparedness", description: "Emergency program and cc_alerts", is_shared: false },
    { category: "transit", source_name: "Road Closures", url: "https://www.surrey.ca/cc_services-payments/roads-transportation", description: "Road closures and transportation", is_shared: false },
  ],
  "City of Coquitlam": [
    { category: "emergency", source_name: "Coquitlam Emergency", url: "https://www.coquitlam.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "City of Port Coquitlam": [
    { category: "emergency", source_name: "PoCo Emergency", url: "https://www.portcoquitlam.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "City of Port Moody": [
    { category: "emergency", source_name: "Port Moody Emergency", url: "https://www.portmoody.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "City of New Westminster": [
    { category: "emergency", source_name: "New West Emergency", url: "https://www.newwestcity.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "City of North Vancouver": [
    { category: "emergency", source_name: "CNV Emergency", url: "https://www.cnv.org/city-cc_services/emergency-preparedness", description: "Emergency cc_services", is_shared: false },
  ],
  "District of North Vancouver": [
    { category: "emergency", source_name: "DNV Emergency", url: "https://www.dnv.org/emergency-preparedness", description: "Emergency cc_services", is_shared: false },
  ],
  "City of Langley": [
    { category: "emergency", source_name: "Langley City Emergency", url: "https://www.langleycity.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "Township of Langley": [
    { category: "emergency", source_name: "TOL Emergency", url: "https://www.tol.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "City of Maple Ridge": [
    { category: "emergency", source_name: "Maple Ridge Emergency", url: "https://www.mapleridge.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "City of Pitt Meadows": [
    { category: "emergency", source_name: "Pitt Meadows Emergency", url: "https://www.pittmeadows.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ...
  "City of White Rock": [
    { category: "water", source_name: "Water Services", url: "https://www.whiterockcity.ca/residents/utilities/water-cc_services", description: "Water utility service and quality reports", is_shared: false },
    { category: "emergency", source_name: "White Rock Fire", url: "https://www.whiterockcity.ca/fire-rescue", description: "Fire and rescue cc_services", is_shared: false },
  ],
  "Village of Belcarra": [
    { category: "emergency", source_name: "Belcarra Emergency", url: "https://www.belcarra.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "Bowen Island Municipality": [
    { category: "emergency", source_name: "Bowen Island Emergency", url: "https://www.bowenislandmunicipality.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "Village of Lions Bay": [
    { category: "emergency", source_name: "Lions Bay Emergency", url: "https://www.lionsbay.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "Tsawwassen First Nation": [
    { category: "emergency", source_name: "TFN Emergency", url: "https://www.tsawwassenfirstnation.com", description: "Emergency cc_services", is_shared: false },
  ],
  "City of Chilliwack": [
    { category: "emergency", source_name: "Chilliwack Emergency", url: "https://www.chilliwack.com/main/emergency", description: "Emergency cc_services", is_shared: false },
  ...
  "District of Mission": [
    { category: "emergency", source_name: "Mission Emergency", url: "https://www.mission.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "District of Hope": [
    { category: "emergency", source_name: "Hope Emergency", url: "https://www.hope.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "District of Kent": [
    { category: "emergency", source_name: "Kent Emergency", url: "https://www.kentbc.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "Village of Harrison Hot Springs": [
    { category: "emergency", source_name: "Harrison Emergency", url: "https://www.harrisonhotsprings.ca/emergency", description: "Emergency cc_services", is_shared: false },
  ],
  "Bamfield": [
    // Community & Emergency
    ...
    { category: "tsunami", source_name: "Tsunami Alerts", url: "https://wcatwc.arh.noaa.gov/", description: "West Coast/Alaska Tsunami Warning Center cc_alerts", is_shared: false },
    ...
    { category: "park", source_name: "West Coast Trail", url: "https://parks.canada.ca/pn-np/bc/pacificrim/activ/activ6", description: "Trail conditions and cc_reservations", is_shared: false },
    // Facilities
